...
Deterministische, kuratierte Zuordnung Frage → Domäne → Seiten. Kein Modell,
keine Wahrscheinlichkeit: ein nachvollziehbarer Hinweis, den das Modell bei
der finalen Einordnung überstimmen darf (und das Überstimmen benennt).
Treffen Schlagworte mehrerer Domänen zu, ist die Frage eine **Mischfrage**
...
- knowledge/demo-okf/llm-wiki-muster.md
- knowledge/demo-okf/ontologie-strategie.md
